import type { User, Company, Project, Task, Invoice, Notification } from '../types'
...
export const mockProjects: Project[] = [
  {
    ...
    ownerType: 'company',
    teamMembers: [
      { id: '1', userId: '1', name: 'Sarah Smith', email: 'sarah@company.com', role: 'manager', joinedAt: '2024-01-01T00:00:00Z' },
      { id: '2', userId: '2', name: 'John Developer', email: 'john@company.com', role: 'staff', joinedAt: '2024-01-05T00:00:00Z' },
    ],
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2024-01-01T00:00:00Z',
  },
